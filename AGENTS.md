...
Source: [the supplied problem statement](SIH26140.md). This describes the full platform. The current MVP implements deliberately narrow examples and supports **Qiskit Aer, Cirq and PennyLane**. A contextual Gemini tutor supports Learn, Lab and Progress. Treat the current `SIH26140.md` as the requirements reference; its omission of qBraid is intentional.
...
Verify a signed-in browser run and saved submission after backend/schema changes.
